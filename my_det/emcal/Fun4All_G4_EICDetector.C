    ...
    const string &outdir = ".")
{
  ...
  if (Input::SIMPLE)
  {
    ...
    //    INPUTGENERATOR::SimpleEventGenerator[0]->set_eta_range(-3., -1.9);
    INPUTGENERATOR::SimpleEventGenerator[0]->set_eta_range(-1.8, -1.5);

    //    INPUTGENERATOR::SimpleEventGenerator[0]->set_eta_range(-2.0, -1.8);

    INPUTGENERATOR::SimpleEventGenerator[0]->set_phi_range(-M_PI, M_PI);
    INPUTGENERATOR::SimpleEventGenerator[0]->set_p_range(1., 10.);
  }
  ...
  if (Input::GUN)
  {
    ...
    //    INPUTGENERATOR::Gun[0]->AddParticle("e-", 1., 1., -10);
...
*/
  ...
  */
  ...
  if (Enable::EEMC_EVAL) EEMC_Eval("g4eemc_eval.root");
