...
void EEMC_Towers()
{
  ...
  const double EEMC_photoelectron_per_GeV_crystal = 100;
  const double EEMC_photoelectron_per_GeV_glass = 100;

  const double crystal_pedestal_ADC = 8, crystal_zero_suppression_ADC = 16;
  const double glass_pedestal_ADC = 8, glass_zero_suppression_ADC = 16;
